...
def ada_boost_classifier(categories):
	...
	for category in categories:
		...
		classifier_predicted = ada.predict(test_data)
...
if __name__ == "__main__":
	...
	ABC_f1, ABC_accuracy, ABC_cnfsn = ada_boost_classifier(categories)
	...
	for category in categories:
		...
		print("\tf1_score: {0}".format(ABC_f1[category]))
		print("\tAccuracy: {0}".format(ABC_accuracy[category]))
